...
ALTER TABLE [dbo].[Translations]
    ADD FOREIGN KEY ([Book]) REFERENCES [dbo].[Books] ([BookId]) ON DELETE CASCADE;
...
GO
ALTER TABLE [dbo].[Translations]
    ADD FOREIGN KEY ([Language]) REFERENCES [dbo].[Languages] ([LanguageId]);
...
('German'),
('Italian')
INSERT INTO [Books] (Title, Year, Author, Pages, Rating)
VALUES
...
INSERT INTO [Translations] (Book, Language)
VALUES
(1000,1),
(1000,2),
(1000,3),
